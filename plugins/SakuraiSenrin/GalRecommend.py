"""
    项目原地址：https://github.com/Hajimarino-HOPE/SakuraiSenrin
    采用GPLv3开源
    源码修改部分：
    1、注释掉check_white_list_all的import
    2、去掉了Random_Gal和Tag_List两个on_command响应器中的规则部分
    3、将Random_Gal响应器的命令从gal改为随机gal
...
Random_Gal = on_command('随机gal', priority=5)  # gal random
Tag_List = on_command('taglist', priority=5)
